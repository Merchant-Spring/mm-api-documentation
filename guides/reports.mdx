...
Many of our endpoints require you to provide two MerchantSpring channel identifiers - **_merchantId_** & **_channelId_**. In order to know what these parameters are we provide a `/channels` endpoint at the first point of contact for all report requests. The response from the channels endpoint will looks like the following:
